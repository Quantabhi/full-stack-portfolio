...
const Header = () => {
    ...
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
          ...
          <h3
              className='flex items-end gap-2 text-xl md:text-2xl mb-3 '>Hi I'm Abhijit Mondal
              <Image src={assets.verify} alt='' className='w-7' >
              </Image> </h3>
            <h1
                className='text-3xl sm:text-6xl lg:text-[48px] font-extrabold '>
                Full Stack Web Developer Based in Kolkata, IN
            </h1>
